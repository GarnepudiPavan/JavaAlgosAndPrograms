package Section2.DSAlgorithmsJavaEleven;
...
public class KMP {
    public static void main(String args[]) throws FileNotFoundException {
        ...
        String fullText = "";
        FileReader myReader = new FileReader(new File("src/Section2/DSAlgorithmsJavaEleven/sourcefile.txt"));
        		//"/Users/edljr/Dropbox (three19)/Java/IdeaProjects/StringDemonstration/src/sourcefile.txt"));
